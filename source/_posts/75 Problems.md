...
25) Can a plane set, such that any straight line meets it at two (and only two) points, be measurable ($B$)? (The existence of such a set has been demonstrated , using M. Zermelo’s theorem, by MM. Mazurkiewicz[^1] (in 1914) and Rosenthal[^2] (in 1922))
